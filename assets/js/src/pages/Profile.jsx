...
const Profile = () => {
  ...
  const getRoleBadgeColor = (role) => {
    const colors = {
      ...
      hospital_nurse: 'bg-teal-100 text-teal-800 border-teal-200',
      hospital_staff: 'bg-cyan-100 text-cyan-800 border-cyan-200',
      pharmacy_staff: 'bg-amber-100 text-amber-800 border-amber-200',
      inventory_manager: 'bg-lime-100 text-lime-800 border-lime-200'
    };
